...
const {data: person, refresh} = await useFetch<Person>(`/api/persons/${id}`, {headers})
...
const state = reactive<Partial<Schema>>({
  ...
  birthDate: toDateInput(person.value.birthDate),
  deathDate: toDateInput(person.value.deathDate),
